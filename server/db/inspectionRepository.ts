...
class InspectionRepository {
  ...
  public async getRiskIntelligence(): Promise<RiskIntelligenceAnalytics> {
    ...
    const categoryStats: Record<string, { total: number; violations: number }> = {};
    ...
    all.forEach((insp) => {
      ...
      if (res.overallStatus === 'COMPLIANT') compliantCount++;
      ...
      res.evaluations.forEach((ev) => {
        if (ev.status === 'FAIL' || ev.status === 'WARNING') {
          ...
          violationCounts[ev.rule_id].count++;
        }
      });
    ...
    const commonMissingDeclarations = Object.entries(missingFieldCounts)
    ...
    return {
      ...
      nonCompliantCount,
      needsReviewCount,
      averageComplianceScore: totalInspections > 0 ? Math.round(totalScore / totalInspections) : 0,
      commonViolations,
      ...
      recentTrends: [
        ...
        { date: 'Aug 2026 W2', inspectionsCount: Math.max(1, Math.round(totalInspections * 0.25)), complianceRate: 68 },
        { date: 'Aug 2026 W3', inspectionsCount: Math.max(2, Math.round(totalInspections * 0.3)), complianceRate: 82 },
        { date: 'Aug 2026 W4', inspectionsCount: Math.max(1, Math.round(totalInspections * 0.25)), complianceRate: 70 },
      ],
    };
  }
  ...
  public async seedInitialSamples(): Promise<void> {
    ...
    const samples: Inspection[] = [
      {
        id: 'INSP-2026-001',
        title: 'Himalayan Organic Wild Honey 500g',
        productName: 'Himalayan Organic Wild Honey',
        brand: 'NaturePure Botanicals',
        inspectorName: 'S. Sharma, Senior Legal Metrology Officer',
        inspectorLocation: 'North Zone Inspection Directorate, Delhi',
        batchNumber: 'NP-HMY-2026-B4',
        retailerName: 'Metro Supermart Pvt Ltd, Rohini',
        ...
        result: {
          ...
          extractedDeclarations: {
            product_name: { value: 'Himalayan Organic Wild Honey', confidence: 0.96, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            brand: { value: 'NaturePure Botanicals', confidence: 0.98, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            product_category: { value: 'Food & Sweeteners', confidence: 0.92, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            generic_or_common_name: { value: 'Pure Honey', confidence: 0.95, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            manufacturer_name: { value: 'NaturePure Agro Foods Ltd.', confidence: 0.94, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            manufacturer_address: { value: 'Village Bhimtal, Dist. Nainital, Uttarakhand - 263136', confidence: 0.92, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            packer_name: { value: 'NaturePure Agro Foods Ltd.', confidence: 0.94, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            packer_address: { value: 'Village Bhimtal, Dist. Nainital, Uttarakhand - 263136', confidence: 0.92, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            ...
            net_quantity: { value: '500 g', confidence: 0.98, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            quantity_value: { value: 500, confidence: 0.98, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            quantity_unit: { value: 'g', confidence: 0.98, sourceImageId: 'img_s1_1', sourceSide: 'front', status: 'found' },
            unit_sale_price: { value: '₹ 0.79 / g', confidence: 0.9, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            mrp: { value: '₹ 395.00 (inclusive of all taxes)', confidence: 0.98, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            currency: { value: 'INR', confidence: 0.98, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            manufacturing_date: { value: '04/2026', confidence: 0.94, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            packing_date: { value: '04/2026', confidence: 0.94, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            import_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            expiry_date: { value: '18 Months from Packing (10/2027)', confidence: 0.92, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            best_before: { value: '18 Months from Packing', confidence: 0.92, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            consumer_care_name: { value: 'Customer Support Manager', confidence: 0.9, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            consumer_care_address: { value: 'NaturePure Support Cell, Nainital, Uttarakhand - 263136', confidence: 0.9, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            consumer_care_phone: { value: '1800-889-4321', confidence: 0.98, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            consumer_care_email: { value: 'customercare@naturepure.in', confidence: 0.98, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            country_of_origin: { value: 'India', confidence: 0.96, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            is_imported: { value: false, confidence: 0.98, sourceImageId: 'img_s1_2', sourceSide: 'back', status: 'found' },
            visible_declarations: ['Product Name', 'Brand', 'Generic Name', 'Net Qty 500g', 'MRP ₹395 incl. of all taxes', 'Mfg Date 04/2026', 'Best Before 18 Months', 'Mfg Address', 'Consumer Care'],
      ...
      {
        id: 'INSP-2026-002',
        title: 'Crunchy Nut Cashew Cookies 250g',
        productName: 'Crunchy Nut Cashew Delight Cookies',
        brand: 'BakersTreat',
        inspectorName: 'A. Verma, Inspector Legal Metrology',
        inspectorLocation: 'Connaught Place Range, New Delhi',
        batchNumber: 'BT-CK-9901',
        retailerName: 'Everfresh Grocers, Saket',
        ...
        result: {
          ...
          extractedDeclarations: {
            product_name: { value: 'Crunchy Nut Cashew Delight Cookies', confidence: 0.95, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            brand: { value: 'BakersTreat', confidence: 0.96, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            product_category: { value: 'Bakery Confectionery', confidence: 0.9, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            generic_or_common_name: { value: 'Biscuits / Cookies', confidence: 0.88, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            manufacturer_name: { value: 'Treatwell Foods LLP', confidence: 0.92, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            manufacturer_address: { value: 'Industrial Estate, Okhla Phase III, New Delhi - 110020', confidence: 0.9, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            packer_name: { value: 'Treatwell Foods LLP', confidence: 0.92, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            packer_address: { value: 'Industrial Estate, Okhla Phase III, New Delhi - 110020', confidence: 0.9, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            importer_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            importer_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            net_quantity: { value: '250 gms', confidence: 0.95, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found', evidenceText: 'Net Wt: 250 gms approx' },
            quantity_value: { value: 250, confidence: 0.95, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            quantity_unit: { value: 'gms', confidence: 0.95, sourceImageId: 'img_s2_1', sourceSide: 'front', status: 'found' },
            mrp: { value: 'Rs 60.00', confidence: 0.92, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found', evidenceText: 'MRP Rs 60.00' },
            currency: { value: 'INR', confidence: 0.92, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            manufacturing_date: { value: '03/2026', confidence: 0.88, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            packing_date: { value: '03/2026', confidence: 0.88, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            import_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            expiry_date: { value: '6 Months from Mfg', confidence: 0.9, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            best_before: { value: '6 Months from Mfg', confidence: 0.9, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            consumer_care_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_phone: { value: '9811000000', confidence: 0.85, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            consumer_care_email: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            country_of_origin: { value: 'India', confidence: 0.9, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            is_imported: { value: false, confidence: 0.95, sourceImageId: 'img_s2_2', sourceSide: 'back', status: 'found' },
            visible_declarations: ['Product Name', 'Brand', 'Net Wt: 250 gms approx', 'MRP Rs 60.00', 'Mfg Date 03/2026'],
            unreadable_declarations: [],
            possible_missing_declarations: ['Mandatory "incl. of all taxes" text', 'Consumer care email and postal address', 'Correct unit symbol (g instead of gms)'],
      ...
      {
        id: 'INSP-2026-003',
        title: 'Instant Lemon Green Tea 25 Sachets',
        productName: 'Instant Lemon Green Tea',
        brand: 'TeaZen Vitality',
        inspectorName: 'P. Nair, Assistant Controller',
        inspectorLocation: 'South Directorate, Bengaluru',
        ...
        result: {
          ...
          extractedDeclarations: {
            product_name: { value: 'Instant Lemon Green Tea', confidence: 0.94, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            brand: { value: 'TeaZen Vitality', confidence: 0.96, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            product_category: { value: 'Beverages Tea', confidence: 0.9, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            generic_or_common_name: { value: 'Green Tea Premix', confidence: 0.88, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            manufacturer_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            manufacturer_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            packer_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            packer_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            importer_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            importer_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            net_quantity: { value: '50 g (25 N × 2 g)', confidence: 0.94, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            quantity_value: { value: 50, confidence: 0.94, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            quantity_unit: { value: 'g', confidence: 0.94, sourceImageId: 'img_s3_1', sourceSide: 'front', status: 'found' },
            mrp: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            currency: { value: 'INR', confidence: 0.5, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            manufacturing_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            packing_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            import_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            expiry_date: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            best_before: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_name: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_address: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_phone: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            consumer_care_email: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            country_of_origin: { value: null, confidence: 0, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            is_imported: { value: false, confidence: 0.5, sourceImageId: '', sourceSide: 'other', status: 'not_found' },
            visible_declarations: ['Product Name: Instant Lemon Green Tea', 'Brand: TeaZen', 'Net Qty: 50 g (25 N × 2 g)'],
            unreadable_declarations: [],
            possible_missing_declarations: ['Manufacturer Name/Address', 'MRP & Tax declaration', 'Date of packing', 'Consumer Care'],
